...
open class Ev3DirectCommand {
     ...
     */
    open func turnMotorAtPower(onPorts ports: OutputPort, withPower power: Int16){
     ...
     */
    open func turnMotorAtSpeed(onPorts ports: OutputPort, withSpeed speed: Int16){
        let c = Ev3Command(commandType: .directNoReply)
    ...
    /**
        ...
        - parameter brake: Apply brake to motor at end of routine.
     */
    open func stopMotor(onPorts ports: OutputPort, withBrake brake: Bool){
        let c = Ev3Command(commandType: .directNoReply)
     ...
     */
    open func getFirmwareVersion(_ receivedFirmware: @escaping (String?) -> Void){
        ...
        c.response?.responseReceivedCallback = {
            ...
            else if let str = String(data: c.response!.data!, encoding: String.Encoding.utf8) {
     ...
     */
    open func getDeviceName(_ port: InputPort, receivedDeviceName: @escaping (String?) -> Void) {
     ...
     */
    open func getBatteryLevel(_ receivedBatLevel: @escaping (UInt8?) -> Void){
     ...
     */
    open func isBrickButtonPressed(_ button: BrickButton, receivedButtonState: @escaping (Bool?) -> Void){
     ...
     */
    open func readyRaw(_ port: InputPort, mode: UInt8, receivedRaw: @escaping (Data?) -> Void){
     ...
     */
    open func programStart(_ name: String, debug: Bool){
