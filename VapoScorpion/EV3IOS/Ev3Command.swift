...
open class Ev3Command {
     ...
     */
    open func initialize(_ commandType: CommandType, globalSize: UInt16, localSize: Int){
    ...
    open func initialize(_ commandType: CommandType) {
    ...
    /************** Michelle ***************/
    /************** add system commands ****/
    func addSystemOpcode(_ opcode: SystemOpcode) {
        buffer!.appendUInt8(UInt8(opcode.rawValue))
    }
    func addMessageTitle(_ s: String) {
        let titleLen : UInt8 = UInt8(s.characters.count+1)
        buffer!.appendUInt8(titleLen)
        let bytes: [UInt8] = [UInt8](s.utf8)
        buffer?.append(bytes, length: bytes.count)
        buffer?.appendUInt8(0x00)
    }
    func addMessageString(_ s: String) {
        let titleLen : UInt16 = UInt16(s.characters.count+1)
        buffer!.appendUInt16LE(titleLen)
        let bytes: [UInt8] = [UInt8](s.utf8)
        buffer?.append(bytes, length: bytes.count)
        buffer?.appendUInt8(0x00)
        addMessageTitle(s)
    ...
    open func writeMailbox(_ title: String, value: String) {
        addSystemOpcode(SystemOpcode.writeMailbox)
        addMessageTitle(title)
        addMessageString(value)
    }
    open func writeMailbox(_ title: String, value: Bool) {
        addSystemOpcode(SystemOpcode.writeMailbox)
        addMessageTitle(title)
        addMessageLogic(value)
    }
    /***************************************/
     ...
     */
    open func setLedPattern(_ ledPattern: LedPattern) {
     ...
     */
    open func turnMotorAtPower(_ ports: OutputPort, power: Int16) {
     ...
     */
    open func turnMotorAtSpeed(_ ports: OutputPort, speed: Int16){
     ...
     */
    open func stepMotorAtSpeed(_ ports: OutputPort, speed: Int16, steps: UInt32, brake: Bool){
    ...
    /**
     ...
     - parameter brake: apply brake to motor(s) at the end of routine
     */
    open func stepMotorAtSpeed(_ ports: OutputPort, speed: Int16, rampUpSteps: UInt32, constantSteps: UInt32, rampDownSteps: UInt32, brake: Bool){
     ...
     */
    open func stepMotorAtPower(_ ports: OutputPort, power: Int16, steps: UInt32, brake: Bool){
    ...
    /**
     ...
     - parameter brake: Apply brake to motor at end of routine
     */
    open func stepMotorAtPower(_ ports: OutputPort, power: Int16, rampUpSteps: UInt32, constantSteps: UInt32, rampDownSteps: UInt32, brake: Bool){
     ...
     */
    open func stepMotorSync(_ ports: OutputPort, speed: Int16, turnRatio: Int16, step: UInt32, brake: Bool){
    ...
    /**
     ...
     - parameter brake: apply brake to motor at end of routine
     */
    open func turnMotorAtSpeedForTime(_ ports: OutputPort, speed: Int16, milliseconds: UInt32, brake: Bool){
    ...
    /**
     ...
     - parameter brake: apply brake to motor at end of routine
     */
    open func turnMotorAtSpeedForTime(_ ports: OutputPort, speed: Int16, msRampUp: UInt32, msConstant: UInt32, msRampDown: UInt32, brake: Bool){
     ...
     * 200: One motor will run with specified power forward while the other will run in the
     ...
     - parameter brake: brake or coast at the end
     */
    open func timeMotorSync(_ ports: OutputPort, speed: Int16, turnRatio: Int16, time: UInt32, brake: Bool){
     ...
     */
    open func clearCount(_ ports: OutputPort){
    ...
    */
    open func startMotor(_ ports: OutputPort) {
     ...
     */
    open func stopMotor(_ ports: OutputPort, brake: Bool) {
     ...
     */
    open func getFirwmareVersion(_ maxLength: UInt8, index: UInt32) {
     ...
     */
    open func isBrickButtonPressed(_ button: BrickButton, index: Int) {
    ...
    */
    open func getTypeMode(_ port: InputPort, typeIndex: Int, modeIndex: Int) {
     ...
     */
    open func readySI(_ port: InputPort, mode: UInt8, index: Int) {
     ...
     */
    open func readyRaw(_ port: InputPort, mode: UInt8, index: Int){
    ...
    /**
     ...
     - parameter index: The index in the global buffer to hold the return value. Index cannot be greater than 1024.
     */
    open func readyPercent(_ port: InputPort, mode: UInt8, index: Int) {
     ...
     */
    open func playTone(_ volume: UInt8, frequency: UInt16, duration: UInt16) {
     ...
     */
    open func playSound(_ volume: UInt8, filename: String){
     ...
     */
    open func getDeviceName(_ port: InputPort, bufferSize: Int, index: Int) {
    ...
    */
    open func getBatteryLevel(_ index: Int){
     ...
     */
    open func getBatteryVoltage(_ index: Int){
     ...
     */
    open func programStart(_ programId: UInt16, filename: String, sizeIndex: Int, ipIndex: Int, debug: Bool){
     ...
     */
    open func loadImage(_ id: UInt16, name: String, sizeIndex: Int, ipIndex: Int){
     ...
     */
    open func outputReady(_ ports: OutputPort){
     ...
     */
    open func outputSetType(_ ports: OutputPort, type: DeviceType){
